...
import 'package:food_suggester/screens/ingredients_page.dart';
...
class ShowRecipeInfo extends StatelessWidget {
  const ShowRecipeInfo({
    ...
    required this.id,
    this.model,
    required this.showMissedIngredients,
  });
  final String imageUrl;
  final String title;
  final int id;
  final bool showMissedIngredients;
  final RecipesByIngredientsModel? model;
                  ...
                  ? ConstrainedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return ImageCard(
                            color: Colors.white,
                            imageUrl: model!.missingIngredients[index].image,
                            name: model!.missingIngredients[index].name,
                          );
                        },
                      ),
                    )
